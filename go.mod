...
require (
	github.com/Telmate/proxmox-api-go v0.0.0-20250623164240-5fcf1e9a57c4
...
replace github.com/qiniu/go-sdk/v7 v7.25.4 => github.com/eust-w/go-sdk/v7 v7.0.0-20241227075816-21fcf3d121a7
